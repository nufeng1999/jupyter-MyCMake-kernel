![](https://img.shields.io/badge/Jupyter-Kernel-green?link=https://jupyter.org/&link=https://github.com/jupyter/jupyter/wiki/Jupyter-kernels) ![](https://img.shields.io/badge/MyCMake-Kernel-orange) ![](https://img.shields.io/github/watchers/nufeng1999/jupyter-MyCMake-kernel) <img alt="ViewCount" src="https://views.whatilearened.today/views/github/nufeng1999/jupyter-MyCMake-kernel.svg">
    <a href="https://github.com/nufeng1999/jupyter-MyCMake-kernel"><img alt="GitHub Clones" src="https://img.shields.io/badge/dynamic/json?color=success&label=Clone&query=count&url=https://raw.githubusercontent.com/nufeng1999/jupyter-MyCMake-kernel/master/clone.json&logo=github"></a>
# MyCMake kernel for Jupyter  
[Example](https://github.com/nufeng1999/jupyter-MyCMake-kernel/blob/master/example/MyCMake.ipynb "Example")
...
### Step-by-step
```bash
npm i @mermaid-js/mermaid-cli -g
pip install matplotlib
pip install zerorpc
git clone https://github.com/nufeng1999/jupyter-MyCMake-kernel.git
cd jupyter-MyCMake-kernel
pip install -e . 
cd jupyter_MyCMake_kernel && python3 install_MyCMake_kernel --user
